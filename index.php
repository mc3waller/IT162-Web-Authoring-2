<?php include('includes/header.php'); ?>
            ...
            <aside>
                <h3>Side Column</h3>
                <img src="images/tablet.jpg" class="tablet" alt="Malik and Liz" />
                <p>Not yet sure what should go here, so let's set this "aside" for now.</p>
            </aside>
            <!-- END RIGHT COLUMN -->
